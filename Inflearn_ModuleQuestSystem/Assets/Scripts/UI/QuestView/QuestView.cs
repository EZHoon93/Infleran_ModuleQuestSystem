...
public class QuestView : MonoBehaviour
{
    ...
    private void ShowDetatil(bool isOn, Quest quest)
    {
        if (isOn)
    ...
    {
        questListViewController.AddQuestToActiveListView(quest, ison => ShowDetatil(ison, quest));

    }
    private void AddQuestToCompletedListView(Quest quest)
    {
        questListViewController.AddQuestToCompletedListView(quest, isOn => ShowDetatil(isOn, quest));
